"""
Example demonstrating the streaming and multithreading capabilities of SQLMind.
"""
...
from sqlmind import SQLMindAzure, EventType
...
sqlmind._streaming_pipeline.executor.register_event_handler("*", handle_streaming_event)
...
def demo_threading():
    ...
    task_ids = []
    for q in questions:
        task_id = sqlmind.ask(q, streaming=True)
