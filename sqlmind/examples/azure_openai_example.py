"""
SQLMind Azure OpenAI Example

This example demonstrates using SQLMind with Azure OpenAI, including
...
# --- Initialize SQLMind Azure ---
sqlmind = SQLMindAzure(config)

# --- Connect to a SQLite database ---
sqlmind.connect_to_sqlite(":memory:")  # In-memory database for demo
...
# --- Add schema information to SQLMind ---
schema = """
CREATE TABLE products (
    product_id INTEGER PRIMARY KEY,
    name TEXT,
...
sqlmind.add_documentation(documentation)
...
from sqlmind.utils import extract_content_from_xml_tags
...
for example in example_pairs:
    ...
    sqlmind.add_question_sql(example["question"], sql)

# --- Run a query ---
print("\n----- Example 1: Basic Query -----")
question = "What are the top 3 best-selling products by quantity?"
result = sqlmind.smart_query(question)
...
analysis = sqlmind.analyze_data(question, visualize=True, explain=True, suggest_followups=True)
...
sqlmind.demo("What are the monthly sales trends for Electronics products in 2023?")