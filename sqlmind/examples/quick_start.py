"""
SQLMind Quick Start Example

This example demonstrates the basic usage of SQLMind with Azure OpenAI, 
...
from sqlmind.utils import format_sql_with_xml_tags
...
sql = sqlmind.generate_sql(question)
...
sql, df, _ = sqlmind.ask(question, auto_train=True)
if df is not None:
    explanation = sqlmind.explain_results(question, df)
    print("\nExplanation:")
    print(explanation)
