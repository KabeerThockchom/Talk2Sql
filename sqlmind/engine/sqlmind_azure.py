...
class SQLMindAzure(QdrantVectorStore, AzureOpenAILLM):
    """
    Main SQLMind engine that combines Qdrant vector storage and Azure OpenAI capabilities.
    This class replaces the original Anthropic implementation with Azure OpenAI services.
    """
    
    def __init__(self, config=None):
        """
        Initialize SQLMind with Azure OpenAI and Qdrant.
