...
from .base import SQLMindBase

class QdrantVectorStore(SQLMindBase):
    ...
    def __init__(self, config=None):
        ...
        # Collection names
        self.questions_collection = config.get("questions_collection", "sqlmind_questions")
        self.schema_collection = config.get("schema_collection", "sqlmind_schema")
        self.docs_collection = config.get("docs_collection", "sqlmind_docs")
        
        # Initialize Qdrant client with cloud configuration
        # Default to SQLMind's Qdrant cloud instance if not specified
