"""
Example Flask application that demonstrates Talk2SQL's streaming capabilities.
"""
...
from talk2sql import Talk2SQLAzure, create_flask_streaming_endpoint
...
create_flask_streaming_endpoint(app, Talk2SQL._streaming_pipeline)
...
<html>
<head>
    <title>Talk2SQL Streaming Demo</title>
    <meta charset="UTF-8">
