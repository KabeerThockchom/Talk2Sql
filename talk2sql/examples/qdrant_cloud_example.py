#!/usr/bin/env python
"""
Example script demonstrating how to use Talk2SQL with Qdrant Cloud vector storage.
"""

import os
from talk2sql.engine import Talk2SQLAzure
from talk2sql.vector_store import QdrantVectorStore
...
def main():
    ...
    qdrant_config = {
        ...
        "questions_collection": "Talk2SQL_questions",
        "schema_collection": "Talk2SQL_schema",
        "docs_collection": "Talk2SQL_docs",
