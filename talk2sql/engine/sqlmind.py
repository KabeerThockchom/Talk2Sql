...
class Talk2SQL(QdrantVectorStore, AnthropicLLM):
    """
    Main Talk2SQL engine that combines Qdrant vector storage and Anthropic LLM.
    This is the primary class to use for text-to-SQL applications.
    """
    
    def __init__(self, config=None):
        """
        Initialize Talk2SQL with configuration.
